...
func TestBuildSoldierCharacterNeverQualified(t *testing.T) {
	...
	c, ok := buildSoldierCharacter(r, upp, "A000000-0", homeworldSkills, false, false)
...
func TestBuildSoldierCharacterDies(t *testing.T) {
	...
	for range 200 {
		c, ok := buildSoldierCharacter(r, upp, "hw", nil, false, false)
...
func TestBuildSoldierCharacterQualified(t *testing.T) {
	...
	c, ok := buildSoldierCharacter(r, upp, "hw", homeworldSkills, false, false)
