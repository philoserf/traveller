...
func TestBuildSpacerCharacterNeverQualified(t *testing.T) {
	...
	c, ok := buildSpacerCharacter(r, upp, "A000000-0", homeworldSkills, false, false)
...
func TestBuildSpacerCharacterDies(t *testing.T) {
	...
	for range 200 {
		c, ok := buildSpacerCharacter(r, upp, "hw", nil, false, false)
...
func TestBuildSpacerCharacterQualified(t *testing.T) {
	...
	c, ok := buildSpacerCharacter(r, upp, "hw", homeworldSkills, false, false)
